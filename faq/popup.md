...
弹窗上线前，自己进行测试时的展示和点击数据也会计算进来，所以在触达数据页看到的是全部的数据。
...
由于 GTouch SDK 依赖无埋点 SDK ，在低于 Android 4.2 的系统中，无埋点 SDK 会自动关闭，这样我们的弹窗触达功能也会自动关闭，不会影响任何业务。
